document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = [
        {
            question: "What is the primary purpose of using appearance: none on input elements?",
            options: [
        ...
        {
            question: "Which of the following is NOT mentioned as a benefit of using appearance: none on input elements?",
            options: [
        ...
        {
            question: "What potential drawback of using appearance: none is mentioned in the lesson?",
            options: [
